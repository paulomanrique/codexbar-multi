...
- [ ] Port cookie/web providers using isolated Electron sessions plus manual fallback (15 providers are partial through Ollama/Windsurf/MiMo and Sakana/Abacus/Mistral).

...
- [ ] Complete local/CLI/OAuth parity; Amp, Kiro, and JetBrains now use injected local adapters, while Grok remains intentionally unregistered until its RPC contract is confirmed.
